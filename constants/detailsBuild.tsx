export const details = [
  {
    content: (
      <>
        <h2>Get Started</h2>
        <p>
          Whether you are new to blockchain development or an advanced
          developer, these resources will give you a foundational understanding
          of Vince Chain and how to use its tools to build efficient
  ...
  },
  {
    content: (
      <>
        ...
        <p>
          Validators are the keepers of the network. Become a Vince Chain
          validator. Help to secure Vince Chain’s Proof-of-Stake (PoS) network
          and earn rewards.
        </p>
      </>
      // <>
      //     <h2>Launch Node</h2>
      //     <p>
      //         Become part of Vince Chain. Take full control on the network. Contribute to the Vince Chain PoS protocol by running Vince Chain’s client software.
      //     </p>
      //     <ul>
  ...
  //             <h2>Become a Validator</h2>
  //             <p>
  //                 Validators are the keepers of the network. Become a Vince Chain validator. Help to secure Vince Chain’s Proof-of-Stake (PoS) network and earn rewards.
  //             </p>
  //         </>
  //     ),
  //     blockquote: {
